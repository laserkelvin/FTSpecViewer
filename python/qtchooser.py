...
"padding: 2px;\n"
"}")
        self.verticalLayout = QtWidgets.QVBoxLayout(ScanChooser)
        self.verticalLayout.setObjectName("verticalLayout")
        self.comboBoxScanChooser = QtWidgets.QComboBox(ScanChooser)
        ...
        self.tableWidgetScanChooser = QtWidgets.QTableWidget(ScanChooser)
        font = QtGui.QFont()
        ...
        self.spinBoxBatchNumber = QtWidgets.QSpinBox(ScanChooser)
        ...
        self.label_5 = QtWidgets.QLabel(ScanChooser)
        ...
        self.line = QtWidgets.QFrame(ScanChooser)
        ...
        self.label_7 = QtWidgets.QLabel(ScanChooser)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_7)
        self.comboBoxWindowFunction = QtWidgets.QComboBox(ScanChooser)
        ...
        self.label_8 = QtWidgets.QLabel(ScanChooser)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_8)
        self.spinBoxExpFilter = QtWidgets.QSpinBox(ScanChooser)
        ...
        self.spinBoxHighPass = QtWidgets.QSpinBox(ScanChooser)
        ...
        self.label_10 = QtWidgets.QLabel(ScanChooser)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_10)
        self.spinBoxDelay = QtWidgets.QSpinBox(ScanChooser)
        ...
        self.label_9 = QtWidgets.QLabel(ScanChooser)
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.pushButtonCloseChooser = QtWidgets.QPushButton(ScanChooser)
        ...
        self.pushButtonOpenScan = QtWidgets.QPushButton(ScanChooser)
        ...
        self.label_9.raise_()
        self.line.raise_()
        self.tableWidgetScanChooser.raise_()
        self.comboBoxScanChooser.raise_()
        self.spinBoxBatchNumber.raise_()

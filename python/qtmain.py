...
"}")
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 296, 750))
        ...
        self.comboBoxRareGas = QtWidgets.QComboBox(self.verticalLayoutWidget_2)
        self.comboBoxRareGas.setObjectName("comboBoxRareGas")
        self.comboBoxRareGas.addItem("")
        self.comboBoxRareGas.addItem("")
        self.comboBoxRareGas.addItem("")
        self.comboBoxRareGas.addItem("")
        self.comboBoxRareGas.addItem("")
        self.comboBoxRareGas.addItem("")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.comboBoxRareGas)
        ...
        self.spinBoxPeakNumber = QtWidgets.QSpinBox(self.verticalLayoutWidget_2)
        self.spinBoxPeakNumber.setObjectName("spinBoxPeakNumber")
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.spinBoxPeakNumber)
        ...
        self.pushButtonRemovePeak = QtWidgets.QPushButton(self.verticalLayoutWidget_2)
        self.pushButtonRemovePeak.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/minus-8x.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushButtonRemovePeak.setIcon(icon)
        self.pushButtonRemovePeak.setObjectName("pushButtonRemovePeak")
        self.formLayout_4.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.pushButtonRemovePeak)
        ...
        self.tableWidgetDopplerPeaks.setMinimumSize(QtCore.QSize(98, 0))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1325, 17))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBoxRareGas.setItemText(0, _translate("MainWindow", "Ne"))
        self.comboBoxRareGas.setItemText(1, _translate("MainWindow", "H2"))
        self.comboBoxRareGas.setItemText(2, _translate("MainWindow", "He"))
        self.comboBoxRareGas.setItemText(3, _translate("MainWindow", "Ar"))
        self.comboBoxRareGas.setItemText(4, _translate("MainWindow", "Kr"))
        self.comboBoxRareGas.setItemText(5, _translate("MainWindow", "Xe"))
        self.label_20.setText(_translate("MainWindow", "Buffer Gas"))
        self.label_21.setText(_translate("MainWindow", "Remove Peak"))
        self.label_24.setText(_translate("MainWindow", "Radical?"))

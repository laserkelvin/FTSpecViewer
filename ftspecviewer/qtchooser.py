...
"}")
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.spinBoxDelay)
        ...
        self.spinBoxLowPass = QtWidgets.QSpinBox(self.horizontalLayoutWidget_2)
        self.spinBoxLowPass.setMaximum(1000)
        self.spinBoxLowPass.setObjectName("spinBoxLowPass")
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.spinBoxLowPass)
    ...
    def retranslateUi(self, ScanChooser):
        ...
        self.spinBoxLowPass.setStatusTip(_translate("ScanChooser", "Apply a high-pass filter (microseconds)"))
        self.label_12.setText(_translate("ScanChooser", "Low-Pass Filter"))
